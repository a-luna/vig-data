<script lang="ts">
	...
	import BatterDetails from '$lib/components/Boxscore/TeamBattingStats/BatterDetails.svelte';
	import BatterStatLine from '$lib/components/Boxscore/TeamBattingStats/BatterStatLine.svelte';
