<script lang="ts">
	...
	import BatterDetails from '$lib/components/Game/Boxscore/TeamBattingStats/BatterDetails.svelte';
	import BatterStatLine from '$lib/components/Game/Boxscore/TeamBattingStats/BatterStatLine.svelte';
