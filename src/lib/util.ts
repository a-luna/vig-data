...
export function getDummyTeamBatStats(): TeamBatStats {
	return {
		year: 0,
		age: 0,
		team_id_bbref: '',
...
export function getDummyPlayerBatStats(): PlayerBatStats {
	return {
		bbref_game_id: '',
		player_id_mlb: 0,
		player_id_bbref: '',
...
export function getDummyPlayerPitchStats(): PlayerPitchStats {
	return {
		bbref_game_id: '',
		player_id_mlb: 0,
		player_id_bbref: '',
