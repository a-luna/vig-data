export const GAME_DATE_REGEX = /\d{4,4}\d{2,2}\d{2,2}/;
export const SEASON_DATE_REGEX = /\d{4,4}-\d{2,2}-\d{2,2}/;
export const GAME_ID_REGEX = /[A-Z]{3,3}\d{4,4}\d{2,2}\d{2,2}\d/;
...
export const INNING_ID_REGEX = /[A-Z]{3,3}\d{4,4}\d{2,2}\d{2,2}\d_INN_(?<inning_half>TOP|BOT)(?<inning_number>[0-9]{2,2})/;
